...
FlashLearn runs costly AI/import workflows, exposes public share links, and persists learning data. The production audit found no distributed abuse protection, tracing, alerting, recovery targets, or release environment separation.
...
- Production requires `FLASHLEARN_ENVIRONMENT=production`, Redis credentials, Sentry DSNs, and a protected health-check token.
