...
/**
 * CapyStudy Spaced Repetition — frozen scheduler configuration.
 *
 * Identity: fsrs-6 / ts-fsrs@5.4.1 / capystudy-v1
 *
 * INVARIANT — changing ANY scheduling-affecting value in this module requires
 * a NEW parameter-set identifier (capystudy-v2 / equivalent). This includes
 ...
 * implementation where behavior changes. capystudy-v1 is immutable. Future
 ...
 */
export const CAPYSTUDY_V1_W = [
  0.212, 1.2931, 2.3065, 8.2956, 6.4133, 0.8334, 3.0194, 0.001, 1.8722, 0.1666, 0.796, 1.4835,
  0.0614, 0.2629, 1.6483, 0.6014, 1.8729, 0.5425, 0.0912, 0.0658, 0.1542,
] as const;

export const CAPYSTUDY_V1_PARAMETERS = {
...
export function createCapyStudyScheduler(): FSRS {
  return fsrs(CAPYSTUDY_V1_PARAMETERS);
}

export { FSR_SCHEDULER_IDENTITY as CAPYSTUDY_SCHEDULER_IDENTITY };
